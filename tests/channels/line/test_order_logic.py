...
async def test_extraction_order_consistency():
    ...
    with patch("channels.line.driver.extract_messages", new_callable=AsyncMock, return_value=mock_messages):
...
async def test_js_order_logic_fix():
    ...
    src_path = os.path.join(os.path.dirname(__file__), "../../../src/channels/line/driver.py")
